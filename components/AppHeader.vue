          ...
          >
            ...
            <div class="p-2">
              <button
                ...
                @click="goAdmin"
                @mouseenter="$event.currentTarget.style.backgroundColor = 'color-mix(in srgb, var(--accent) 6%, transparent)'; $event.currentTarget.style.color = 'var(--accent)'"
...
function goAdmin() {
  ...
  if (!sessionStorage.getItem('admin_auth')) {
    // Trigger admin gate modal via custom event
